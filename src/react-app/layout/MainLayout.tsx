...
import { FileText, Globe2, Home, Loader2, Orbit, Settings, Share2, Sparkles, User, Zap } from "lucide-react";
...
const navItems = [
  ...
  { to: "/website", label: "个人网站", icon: Globe2 },
    ...
    <>
      ...
      <div className="min-h-screen text-slate-900 flex flex-col bg-slate-50/50">
        ...
        {isEditorPage ? (
          ...
          <main className="mx-auto w-full max-w-7xl px-4 py-5 transition-all duration-300 lg:px-6 lg:py-6">
            {children}
          </main>
        )}
      </div>
