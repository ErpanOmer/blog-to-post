		...
		<div className="space-y-4">
			<div className="space-y-2">
				<div className="flex items-center justify-between">
					<label className="text-[13px] font-semibold text-design-text">封面图</label>
				...
				/>
				<div className="h-28 overflow-hidden rounded-lg border border-design-border bg-design-background">
					{article?.coverImage ? (
						<img src={article.coverImage} alt={article.title} className="h-full w-full object-cover" />
					) : (
						<div className="flex h-full items-center justify-center text-[13px] text-design-neutral">生成后将展示封面</div>
					)}
				</div>
			</div>
			...
			<div className="space-y-2">
				<div className="flex items-center justify-between">
					<label className="text-[13px] font-semibold text-design-text">摘要</label>
			...
			<div className="space-y-2">
				<div className="flex items-center justify-between">
					<label className="text-[13px] font-semibold text-design-text">标签</label>
				...
				/>
				<p className="text-[12px] text-design-neutral">点击 AI 按钮会覆盖当前标签。</p>
			</div>
		</div>
	);
}
